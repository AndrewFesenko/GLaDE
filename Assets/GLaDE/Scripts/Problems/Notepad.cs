...
{
    /// <summary>
    /// A drawing surface for hand-written working: free-body sketches, equations, arithmetic. Painted by a
    /// <see cref="Pen"/> whose tip touches it. Needs a MeshCollider (a Quad) so hits carry texture coordinates.
    /// </summary>
    ...
    public class Notepad : MonoBehaviour
    {
        ...
        public float brushRadiusPixels = 5f;
